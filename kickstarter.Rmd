...
```{r}
set.seed(124)
ind <- createDataPartition(data$state_lev_x_successful_clean, p=0.8, list = FALSE)
x_train <- data[ind,-199]
x_train_label <- data[ind,199]
x_train_label <- as.data.frame(x_train_label)
x_test <- data[-ind,199]
x_test <- as.data.frame(x_test)
x_test_label <- data[-ind,199]
...
network %>% fit(x_train,x_train_label, epochs = 50)#, batch_size=10)
